...
public class Server {
  ...
  public void startReactorServer() throws InterruptedException {
    ...
    HttpServer server = HttpServer.create().tcpConfiguration(serverInstance -> serverInstance.host(HOST)).port(PORT);
  ...
  public RouterFunction<ServerResponse> routingFunction() {
    ...
    return nest(path("/user"), nest(accept(MediaType.ALL), route(GET("/"), handler::getAllUsers)));
  }
}
